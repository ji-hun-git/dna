    ...
    <main className={styles.page}>
      <div className={styles.shell}>
        <header className={styles.appbar}>
          ...
          <nav aria-label="주요 메뉴"><a href="/">홈</a><a href="/records" aria-current="page">기록</a><a href="/data-control">데이터 관리</a></nav>
          <span className={styles.appbarState}>서버 저장 합성 기록</span>
        </header>

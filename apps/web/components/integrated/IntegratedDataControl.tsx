    ...
    <main className="gc-data-control">
      <div className="gc-data-control__shell">
        <header className="gc-data-control__appbar">
          <a className="gc-data-control__brand" href="/" aria-label="앎 건강 홈"><span aria-hidden="true">앎</span><strong>앎</strong></a>
          <span>서버 동의 · 삭제 상태</span>
          <a href="/connections">외부 연결 상태</a>
        </header>
        ...
        {!loading && session && (
          <>
            <section className="gc-data-control__summary" aria-label="현재 서버 데이터 상태">
              ...
              <article><span>외부 연결</span><strong>0</strong><p>카카오·네이버·MyHealthWay 비활성화</p></article>
            </section>

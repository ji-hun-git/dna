...
export const identityProviderContractSchema = z.strictObject({
  schemaVersion: z.literal("identity-provider-contract.v2"),
  ...
  tokenEndpointAuthMethod: z.literal("client_secret_post"),
  clientSecretStorage: z.literal("server-secret-manager-only"),
  browserTokenStorage: z.literal("forbidden"),
...
export const identityProviderContracts = {
  kakao: identityProviderContractSchema.parse({
    schemaVersion: "identity-provider-contract.v2",
    id: "kakao",
    releaseStatus: "contract-only-external-registration-required",
    protocol: "oidc-authorization-code",
    issuer: "https://kauth.kakao.com",
    discoveryUri: "https://kauth.kakao.com/.well-known/openid-configuration",
    ...
    clientSecretStorage: "server-secret-manager-only",
  ...
  naver: identityProviderContractSchema.parse({
    ...
    discoveryUri: "https://nid.naver.com/.well-known/openid-configuration",

...
object MedicalConceptCatalogue {
    ...
    val entries: List<MedicalConcept> = listOf(
        ...
        concept("systolic-blood-pressure", "수축기 혈압", "8480-6", true, listOf("mmHg"), "최고혈압", "Systolic", "Systolic Blood Pressure", "SBP", "혈압(수축기)"),
        concept("diastolic-blood-pressure", "이완기 혈압", "8462-4", true, listOf("mmHg"), "최저혈압", "Diastolic", "Diastolic Blood Pressure", "DBP", "혈압(이완기)"),

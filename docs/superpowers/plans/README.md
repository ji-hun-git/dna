...
|---|---|---|---|---|
| FND | [`2026-08-09-platform-foundation-security.md`](2026-08-09-platform-foundation-security.md) | Korea-region, testable modular-monolith foundation with identity, consent, IaC, CI, audit, recovery, and security controls | Founder execution choice; counsel/classification work may run in parallel | Task 1 implemented; local red/green and exact Windows artifact checks pass; Linux-only installer evidence pending pinned CI |

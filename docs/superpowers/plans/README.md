...
|---|---|---|---|---|
| FND | [`2026-08-09-platform-foundation-security.md`](2026-08-09-platform-foundation-security.md) | Korea-region, testable modular-monolith foundation with identity, consent, IaC, CI, audit, recovery, and security controls | Founder execution choice; counsel/classification work may run in parallel | Task 1 implemented and locally committed on `codex/fnd-task-1-bootstrap`; Linux/Python 3.12.13 full-host gate remains for CI; Tasks 2–11 not started |
